...
El ejercicio es contrafactual, así que descansa en un supuesto que conviene leer antes que las
cifras: **el desenlace es propiedad del lead, no del orden en que se atendió.** Si un lead que
cerró hubiera quedado fuera del cupo del día, se cuenta como no cerrado; si entra, cierra. Es el
supuesto estándar de este tipo de simulación y es optimista para cualquier política: nadie cierra
por llamar de primero, solo por haber sido llamado.
