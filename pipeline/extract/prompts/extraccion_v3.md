# Extracción de señales de venta — versión v3

Cambio frente a v2: se corrige la **intención**, que v2 había degradado. Se conservan de v2 el
criterio de que hablar de cuota inicial es crédito y la lista de prioridad de objeciones.
...
4. El cliente dice "estoy es comparando por ahora", después "voy a consultar en la casa y le digo" y
   se despide con "gracias, quedo pendiente". La objeción es `consultar_familia` por la prioridad de
   la lista, y la intención es **baja**: se fue sin dejar ninguna señal de avance.
